...
function sampleEdge(S::Vector{Int64}, Z::Vector{Int64}, ϑ::Vector{Float64}, Ω::AffinityFunction; α::Any)
    ...
    Ω::AffinityFunction, an AffinityFunction governing interaction rates between nodes of different groups. 
...
function sampleEdges(Z::Vector{Int64}, ϑ::Vector{Float64}, Ω::AffinityFunction; α::Vector{Float64}, kmax::Int64=3, kmin::Int64=2)
    """
    ...
    Ω::AffinityFunction, an Affinity function governing the rate of interaction between nodes of various groups.
...
function sampleEdges(Z::Dict, ϑ::Dict, Ω::AffinityFunction; α::Any, kmax::Int64=3, kmin::Int64=2)
    """
